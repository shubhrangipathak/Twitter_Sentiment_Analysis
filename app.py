...
# to run this code type http://localhost:5000 in your local browser
...
def pred1():
	if request.method=='POST':
            ...
            if blob.sentiment.polarity > 0:
                ...
                text_sentiment = "Negative ☹️ "
            return render_template('result1.html',msg=text, result=text_sentiment)


if __name__ == '__main__':
    
    consumer_key = 'tlWvLePU5esJCmqYyhJ4hm2Aq' 
    consumer_secret = 'BQtuezKOP4JL0g4WhnvNPuU3BGkUvWYWOz6g1cmicOZai2hxc3'
    access_token = '1599413781297172482-IQvUutKp4zh9eJx9JawDE822YFfEIy'
    access_token_secret = '0nNJtnRQm6bMLXGaAbDFGguzdFFZE5G0DrNnQmwgA46Gg'
